...
10. Нажать Enter. Скопируются файла с удалённого репозитория. Проект будет выглядеть следующим образом:

<img src="img/cloning.png" width="800" height="200" alt="git cloning">

<img src="img/project_after_cloning.png" width="300" height="300" alt="project root">
